...
| #   | Item                                                                                                                                                                                                                                                                                                                        | Owner              | Status               |
| --- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ | -------------------- |
| 1   | `riskDisclaimer` display is wired and the CMS holds real EN + AR copy (843/720 chars); layout hardened so a blank value falls back to the i18n warning. Remaining: client legal sign-off on the exact wording                                                                                                               | Client legal       | Sign-off             |
...
| 17  | SECURITY: a live production CMS admin `demo@newera.com` (users.id 1) exists with the weak password that was hardcoded in seed scripts. Delete this admin (keep `admin@newera365.com`) or rotate its password immediately. The repo-side credential leak has been removed from active scripts; git history still contains it | Client + dev       | Action now           |
