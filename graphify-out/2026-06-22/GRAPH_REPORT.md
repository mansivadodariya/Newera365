# Graph Report - newera365-app (2026-06-20)

## Corpus Check

- 352 files · ~790,018 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 1994 nodes · 2951 edges · 222 communities (153 shown, 69 thin omitted)
- Extraction: 98% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 44 edges (avg confidence: 0.81)
...
## Communities (222 total, 69 thin omitted)

### Community 0 - "CMS Collections & Data Models"

Cohesion: 0.07
Nodes (36): AccountTypes, AnalystCalls, Awards, BlogPosts, Careers, CompanyMilestones, ContactSubmissions, EducationContent (+28 more)
...
Cohesion: 0.07
Nodes (25): ArbitrageSection(), CARDS, Channel, CHANNELS, CmsContactDetails, ContactPage(), ContactPageProps, Topic (+17 more)
...
Cohesion: 0.07
Nodes (31): AboutRoute(), mapAward(), mapTeamMember(), metadata, resolveUrl(), AwardsRoute(), metadata, AboutPage() (+23 more)
...
Cohesion: 0.15
Nodes (4): FundingPageProps, METHOD_TYPE_ICONS, METHOD_TYPE_LABELS, TRUST_ROWS

### Community 14 - "IB & Contact Pages"

Cohesion: 0.10
Nodes (20): CareersRoute(), metadata, CareersPage(), metadata, NEWS_CAT_TO_ASSET, BLOG_CAT_TO_ASSET, CmsAccountType, CmsAnalystCall (+12 more)

### Community 15 - "Accounts & Calendar Pages"

Cohesion: 0.18
Nodes (8): AccountsRoute(), AccountsPage(), CtaBanner(), IBPage(), NO_CTA_SUFFIXES, IBRoute(), getAccountTypes(), getIBContent()
...
Cohesion: 0.13
Nodes (20): generateMetadata(), generateStaticParams(), Props, generateMetadata(), Props, generateMetadata(), Props, MarketCategoryRoute() (+12 more)
...
Cohesion: 0.20
Nodes (8): DropdownItem, NavItem, LanguageToggle(), LanguageToggleProps, MobileMenu(), MobileMenuProps, NavGroup, useNavGroups()
...
Cohesion: 0.13
Nodes (13): Analytics(), CookieConsent(), CmsFooterColumn, CmsSocialLinks, Footer(), PageFade(), SmartCtaBanner(), BASE (+5 more)

### Community 24 - "Media & Press Page"

Cohesion: 0.15
Nodes (10): BRAND_ASSETS, FEATURED_IN, MediaPressItem, MediaPressPage(), MediaPressPageProps, STATS, CmsMediaPressItem, getMediaPressItems() (+2 more)
...
Cohesion: 0.17
Nodes (13): BASE, entry(), sitemap(), STATIC_PATHS, generateStaticParams(), BlogRoute(), CmsResearchReportItem, ResearchPage() (+5 more)
...
Cohesion: 0.15
Nodes (9): ArticleDisplay, ArticleItem, ASSET_TO_CATEGORY, CAT_COLORS, CATEGORIES, Category, CmsResearchArticle, ResearchPageProps (+1 more)
...
Cohesion: 0.17
Nodes (11): ProfitCalculatorPage(), CmsSpreadInstrument, COMMISSIONS, SpreadComparatorPage(), SpreadComparatorPageProps, CmsCalculatorInstrument, TraderToolsPage(), getInstruments() (+3 more)

### Community 39 - "Media Listing & Webinars"

Cohesion: 0.10
Nodes (14): CareersPageProps, CmsJobItem, TYPE_COLORS, CmsGuide, GuidesPageProps, CATEGORY_TABS, CmsWebinarItem, EpisodeItem (+6 more)
...
Cohesion: 0.10
Nodes (19): generateStaticParams(), AudioRoute(), metadata, CmsEbookItem, EbooksPage(), EbooksPageProps, GuidesPage(), CmsVideoItem (+11 more)
...
Cohesion: 0.13
Nodes (13): FEATURE_STYLES, AR_STAT_VALUES, IBCmsContent, PARTNER_TYPES, STEP_NUMS, StepItem, NewsletterPageProps, CATEGORY_COLORS (+5 more)
...
Cohesion: 0.24
Nodes (10): CmsGuideDetail, GuideDetailPage(), GuideDetailProps, extractHeadings(), extractText(), renderLeaf(), renderNode(), RichTextProps (+2 more)
...
Cohesion: 0.26
Nodes (5): AuthModal(), AuthModalProps, AuthModalType, STATUS_BADGE, WebinarsPageProps
...
Cohesion: 0.17
Nodes (5): EXTENSION_RATIOS, FibDirection, FibLevel, FibonacciCalculatorPage(), RETRACEMENT_RATIOS
...
Cohesion: 0.25
Nodes (7): CmsFaqItem, FaqPage(), FaqsRoute(), metadata, Props, CmsFaq, getFaqs()
...
Cohesion: 0.18
Nodes (7): CONTRACT_SIZES, Instrument, INSTRUMENTS_FALLBACK, PIP_SIZES, ProfitCalculatorPageProps, ProfitResult, TabMode
...
Cohesion: 0.25
Nodes (4): CalcSelect(), CalcSelectProps, ToolTab, TraderToolsPageProps

### Community 79 - "Ticker Strip Component"

Cohesion: 0.08
Nodes (19): AwardsPageSkeleton(), CountUp(), MARKETS, MarketsSectionDemo(), MarketItem, MarketsSectionGrid(), MediaPressPageSkeleton(), PlatformPageSkeleton() (+11 more)
...
Cohesion: 0.25
Nodes (5): Category, CATEGORY_META, Props, VALID_CATEGORIES, MarketCategoryPage()

### Community 87 - "Community 87"

Cohesion: 0.29
Nodes (6): CmsPaymentMethodItem, FundingPage(), FundingRoute(), metadata, CmsPaymentMethod, getPaymentMethods()
...
Cohesion: 0.38
Nodes (4): Geo, Step, ThreeStepsClient(), ThreeStepsSectionDemo()
...
Cohesion: 0.18
Nodes (10): ALPHABET, CATEGORY_COLORS, CmsGlossaryTerm, GlossaryPage(), GlossaryPageProps, GlossaryTerm, RichText(), GlossaryRoute() (+2 more)
...
Cohesion: 0.12
Nodes (13): buildGeo(), CHIPS, Dir, GEO, HeroChartCard(), LineGeo, OPEN, PERIOD_CHANGE (+5 more)

### Community 198 - "Community 198"

Cohesion: 0.18
Nodes (8): dir(), isRtl(), RTL_LOCALES, ASSET_CLASSES, AssetClass, InstrumentSpec, MT5DataSource, MT5Response

### Community 199 - "Community 199"

Cohesion: 0.22
Nodes (6): CmsSpreadRow, FeesPage(), FeesPageProps, OTHER_CHARGES, FeesRoute(), CmsInstrument
...
Cohesion: 0.29
Nodes (6): WebinarItem, WebinarsPage(), CmsWebinar, getWebinars(), metadata, WebinarsRoute()
...
Cohesion: 0.20
Nodes (8): CATEGORIES, CATEGORY_ICONS, CmsEducationItem, EducationHubPage(), EducationHubPageProps, FEATURED, EducationRoute(), metadata
...
Cohesion: 0.33
Nodes (6): ArticleDetailData, CAT_COLORS, RELATED_AR, RELATED_EN, ResearchDetailPageProps, SlateNode
...
- **882 isolated node(s):** `husky.sh script`, `base`, `name`, `version`, `private` (+877 more)
...
- **Why does `CtaBanner()` connect `Accounts & Calendar Pages` to `UI Component Library`, `Company Pages`, `Platform Pages`, `IB & Contact Pages`, `Pivot Calculator`, `Media & Press Page`, `Analyst Chart Page`, `Guides & Market Category`, `Instruments Listing`, `Spread Comparator`, `Ebooks & Gated Content`, `Legal Page Components`, `Media Video Listing`, `Community 193`, `Community 68`, `FAQ Route & Page`, `Community 199`, `Ticker Strip Component`, `Market Category Page`, `Community 212`, `Community 87`, `Community 216`, `Community 107`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `SectionKicker()` connect `Fees Page` to `UI Component Library`, `Company Pages`, `Platform Pages`, `Funding & Payment Page`, `Pivot Calculator`, `Media & Press Page`, `Analyst Chart Page`, `Promotions Page`, `Account Comparison Page`, `Education Hub`, `Instruments Listing`, `Spread Comparator`, `Media Listing & Webinars`, `Careers Page`, `Ebooks & Gated Content`, `FAQ Page`, `Guide Detail Page`, `Media Video Listing`, `Community 193`, `Community 68`, `Community 69`, `Community 199`, `Features Section`, `Community 78`, `Ticker Strip Component`, `Community 216`, `Community 108`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `ArticleDetailSkeleton()` connect `Slug Detail Loading States` to `Loading Skeleton Components`, `Ticker Strip Component`?**
