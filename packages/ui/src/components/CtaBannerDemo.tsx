          ...
          <div className="mx-auto flex max-w-[720px] flex-col items-center gap-7 px-6 py-16 text-center xl:py-20">
            ...
            <div className="flex w-full flex-row flex-wrap items-center justify-center gap-3 sm:gap-4">
              ...
              <button
                ...
                className="font-body focus-visible:ring-accent flex h-[48px] items-center justify-center rounded-full border border-white/20 px-6 text-[15px] font-medium text-white transition-colors hover:border-white/50 focus-visible:outline-none focus-visible:ring-2 active:scale-[0.98] sm:h-[52px] sm:px-8"
              >
                {t('ctaBannerDemo')}
              </button>
            </div>
