...
/**
 * Dark KPI cards with an accent top-edge that lights on hover, a standardised
        ...
        <RevealDemo>
          <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
            {stats.map((stat) => (
              ...
              >
                {/* Accent top edge — lights on hover */}
                <span className="bg-accent absolute inset-x-0 top-0 h-[3px] origin-left scale-x-0 transition-transform duration-300 group-hover:scale-x-100" />
