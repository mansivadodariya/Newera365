        ...
        <div className="relative mx-auto w-full max-w-[1200px]">
          <div className="grid items-center gap-10 xl:grid-cols-[minmax(0,1fr)_480px] xl:items-start xl:gap-6">
            <div className="flex flex-col items-center text-center xl:items-start xl:text-start">
              ...
              <p
                className={`font-body text-lead mt-5 max-w-[620px] text-white ${RISE}`}
              ...
              >
                ...
                <Link
                  href={`/${locale}/support`}
                  className="font-body hover:text-accent-bright inline-flex flex-none items-center gap-1 px-2 py-[18px] text-[14px] font-medium text-white transition-colors"
                >
                  {t('heroCTAContact')}
                  <svg
                    width="13"
