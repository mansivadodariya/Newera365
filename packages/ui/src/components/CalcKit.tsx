...
export function LevelRow({
  ...
  return (
    <div className="-mx-2 flex items-center justify-between rounded-[7px] border-b border-white/5 px-2 py-2 transition-colors last:border-0 hover:bg-white/[0.03]">
      <span
