...
export function ResearchDetailPage({ slug: _slug }: ResearchDetailPageProps) {
      ...
      <section className="bg-background px-5 pb-0 pt-6">
        <div className="mx-auto max-w-[390px] md:max-w-2xl xl:max-w-[1200px]">
          <div className="flex items-center gap-2">
            ...
            <span className="font-body text-muted text-[12px]">Macro</span>
          </div>
        </div>
      </section>
      ...
      <section className="bg-background px-5 pb-6 pt-4">
        <div className="mx-auto max-w-[390px] md:max-w-2xl xl:max-w-[1200px]">
          ...
          <p className="font-body text-muted text-[13px]">
            By <span className="text-foreground font-medium">Anya Morozova</span> · Macro Desk
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[390px] md:max-w-2xl xl:max-w-[1200px]">
          <div className="prose-custom flex flex-col gap-5">
            <p className="font-body text-foreground text-[15px] leading-[1.7]">
              ...
              banks are diverging, and what it means for the major currency pairs over the next nine
              months.
            </p>
            ...
            <div className="flex gap-3 rounded-[14px] bg-[#FFF7ED] p-4 dark:bg-[#2a1a00]">
              ...
              <p className="font-body text-[12px] leading-[1.55] text-[#92400E] dark:text-[#F59E0B]/80">
                Trading leveraged products such as CFDs carries a high level of risk and may not be
                suitable for all investors. You may lose more than your initial deposit. Past
            ...
            {RELATED.map((art) => (
              ...
              >
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-foreground group-hover:text-accent font-sans text-[13px] font-semibold leading-[1.35] transition-colors">
                    {art.title}
                  </p>
                </div>
                <svg
