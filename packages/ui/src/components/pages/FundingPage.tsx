            ...
            {methods.map((method, i) => (
              <ScrollReveal key={method.key} index={i}>
                <div className="border-border shadow-card hover-lift group flex h-full flex-col gap-4 rounded-[20px] border bg-white p-5 dark:border-white/[0.06] dark:bg-[#14161c] dark:shadow-none">
                  {/* Cover tile — full size by default (h-[268px]), decreases to h-[180px] on hover to reveal 2x2 specs grid */}
                  <div className="border-border/60 relative h-[268px] w-full overflow-hidden rounded-[14px] border bg-white shadow-sm transition-[height] duration-300 ease-in-out group-hover:h-[180px] dark:border-white/[0.08] dark:bg-[#161822]">
                    ...
                    <img
                      ...
                      className="absolute inset-0 h-full w-full rounded-[14px] object-cover transition-transform duration-500 ease-out motion-safe:group-hover:scale-[1.03]"
                    />
                  </div>

                  {/* Subtle divider line between cover image and title */}
                  <div className="border-b border-slate-100 dark:border-white/[0.08]" />
                  ...
                  {/* Spec read-out — 2x2 grid (2 details left, 2 details right), expands to 88px on hover matching 88px cover shrinkage */}
                  <div className="border-border h-0 max-h-0 overflow-hidden border-t-0 pt-0 opacity-0 transition-all duration-300 ease-in-out group-hover:h-[88px] group-hover:max-h-[88px] group-hover:border-t group-hover:pt-2.5 group-hover:opacity-100 dark:border-white/[0.08]">
                    <div className="grid grid-cols-2 gap-x-4 gap-y-2">
                      {[
                        ...
                        <div
                          key={stat.label}
                          className="border-border/60 flex flex-col justify-between border-b pb-1.5 dark:border-white/[0.06]"
                        >
                          <span className="text-muted font-mono text-[9.5px] uppercase tracking-[0.1em]">
                            {stat.label}
                          </span>
                          <span
                            dir="auto"
                            className={`font-mono text-[12.5px] font-semibold tabular-nums ${stat.green ? 'text-accent' : 'text-foreground'}`}
                          >
                            {stat.value}
                          </span>
                        </div>
