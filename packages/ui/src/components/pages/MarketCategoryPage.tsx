...
> = {
  forex: {
    ...
    staticRows: [
      ...
      { symbol: 'EUR/JPY', name: 'Euro / Yen', spread: '1.2', change: '+0.35%', up: true },
      { symbol: 'GBP/JPY', name: 'Pound / Yen', spread: '1.5', change: '+0.28%', up: true },
      { symbol: 'EUR/AUD', name: 'Euro / Aussie', spread: '1.4', change: '-0.07%', up: false },
      { symbol: 'GBP/CAD', name: 'Pound / CAD', spread: '1.6', change: '+0.18%', up: true },
      { symbol: 'AUD/JPY', name: 'Aussie / Yen', spread: '1.3', change: '+0.15%', up: true },
      { symbol: 'CAD/JPY', name: 'CAD / Yen', spread: '1.4', change: '+0.10%', up: true },
      { symbol: 'EUR/CAD', name: 'Euro / CAD', spread: '1.3', change: '-0.03%', up: false },
      { symbol: 'NZD/JPY', name: 'NZD / Yen', spread: '1.5', change: '+0.22%', up: true },
      { symbol: 'USD/SGD', name: 'US Dollar / SGD', spread: '1.8', change: '-0.02%', up: false },
        ...
        <ScrollReveal className="mx-auto max-w-[390px] md:max-w-2xl xl:max-w-[1200px]">
          {category === 'forex' ? (
            ...
            <>
              ...
              <div className="relative h-[520px] overflow-hidden rounded-[20px] bg-[#07090D] md:h-[620px] xl:h-[760px] xl:rounded-[24px]">
                <ChartWidget
