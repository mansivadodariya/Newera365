        ...
        <div className="motion-safe:animate-rise-in mx-auto max-w-[390px] md:max-w-2xl xl:max-w-[1200px]">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            ...
            <Link
              ...
              className="text-body hover:border-accent-bright/60 flex h-[50px] w-full items-center justify-center gap-2 rounded-full border border-white/20 px-6 font-sans font-medium text-white transition-colors active:scale-[0.98] sm:w-auto sm:px-8"
            >
              {t('ctaGlossary')}
            </Link>
          </div>
