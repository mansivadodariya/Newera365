        ...
        <div className="mx-auto max-w-[1200px]">
          <ScrollReveal>
            <div className="mb-6 flex flex-col gap-2 xl:flex-row xl:items-end xl:justify-between">
              ...
              <p className="font-body text-caption text-foreground/70 dark:text-white/70">
                Oscillators and moving averages summary updated live from TradingView.
              </p>
            </div>
        ...
        <div className="mx-auto max-w-[1200px]">
          <ScrollReveal>
            <div className="grid grid-cols-1 gap-8 xl:grid-cols-2">
              {/* Currency Heat Map */}
              <div className="border-border flex flex-col overflow-hidden rounded-[24px] border bg-white p-6 dark:border-white/10 dark:bg-[#14161c]">
                <div className="mb-4">
          ...
          <ScrollReveal>
            ...
            <div className="grid grid-cols-1 gap-8 xl:grid-cols-2">
              ...
              <div className="border-border flex flex-col overflow-hidden rounded-[24px] border bg-white p-6 dark:border-white/10 dark:bg-[#14161c]">
                ...
                <div className="h-[480px] w-full overflow-hidden rounded-[16px]">
                  <TradingViewWidget
